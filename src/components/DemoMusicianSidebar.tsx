import { Music, Calendar, BarChart3, Car, Receipt, LogOut, LayoutDashboard, Mic2, HelpCircle, User, Settings } from 'lucide-react';
...
const mainItems = [
  ...
  { title: 'Despesas', url: '/demo/musician/expenses', icon: Receipt },
];
