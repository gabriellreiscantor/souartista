        ...
        <div className="py-4 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/50">
              ...
              <div>
                <p className="text-lg font-bold text-foreground">{stats.totalShows}</p>
            ...
            {userRole === 'artist' && stats.totalMusicians !== undefined && stats.totalMusicians > 0 && (
              <div className="col-span-2 flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/50">
                <div className="w-10 h-10 rounded-full bg-blue-500/10 flex items-center justify-center flex-shrink-0">
                  <Music className="w-5 h-5 text-blue-500" />
                </div>
                <div>
                  <p className="text-lg font-bold text-foreground">{stats.totalMusicians}</p>
            ...
            {userRole === 'musician' && stats.totalArtists !== undefined && stats.totalArtists > 0 && (
              <div className="col-span-2 flex items-center gap-3 p-3 rounded-lg bg-muted/50 border border-border/50">
                ...
                <div>
                  <p className="text-lg font-bold text-foreground">{stats.totalArtists}</p>
