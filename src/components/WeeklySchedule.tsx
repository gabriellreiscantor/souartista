...
export function WeeklySchedule({ userRole }: WeeklyScheduleProps) {
  ...
  if (isLoading) {
    return (
      <Card className="p-4 sm:p-6 bg-card border-border animate-pulse">
  ...
  return (
    <Card className="p-4 sm:p-6 bg-card border-border">
      {/* Header */}
      <div className="mb-4">
        <h3 className="text-lg font-semibold text-foreground mb-2">Agenda da Semana</h3>
      ...
      <div className="flex items-center gap-2 mb-4">
        ...
        <Button variant="outline" className="flex-1 justify-center" onClick={handleToday}>
          Semana Atual
        </Button>
