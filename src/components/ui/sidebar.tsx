...
function useSidebar() {
  ...
  if (!context) {
    // Return default values instead of throwing to prevent crashes during HMR or unmounting
    return {
  ...
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        variant="ghost"
        size="icon"
        className={cn("h-7 w-7 bg-white text-black hover:bg-gray-50", className)}
        onClick={(event) => {
          onClick?.(event);
          toggleSidebar();
        }}
