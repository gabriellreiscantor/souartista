                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                    <div>
                      ...
                      <p className="font-semibold text-gray-900">{settings.showShowCosts ? `R$ ${formatCurrency(totalTeamExpenses)}` : 'R$ *.***,**'}</p>
                    </div>
                    <div>
                      <p className="text-gray-500">Locomoção</p>
                      <p className="font-semibold text-gray-900">{settings.showLocomotion ? `R$ ${formatCurrency(totalLocomotionExpenses)}` : 'R$ *.***,**'}</p>
                    </div>
                    <div>
