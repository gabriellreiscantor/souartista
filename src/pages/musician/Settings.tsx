            ...
            <div className="max-w-2xl mx-auto space-y-6">
                  ...
                  <div className="flex items-center justify-between py-3 border-b border-gray-100">
                    ...
                    <Switch 
                      ...
                      onCheckedChange={(checked) => {
                        ...
                        toast.success(checked ? "Configuração ativada" : "Configuração desativada");
                      }} 
                    />
                  </div>
              ...
              <Card className="p-6 bg-white">
                ...
                <div className="space-y-2">
                  <button
                    onClick={() => navigate('/musician/terms')}
                  ...
                  <button
                    onClick={() => navigate('/musician/privacy')}
                    className="w-full flex items-center gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors text-left"
                  >
                  ...
                  <button
                    onClick={() => navigate('/musician/updates')}
                    className="w-full flex items-center gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors text-left"
                  >
                  ...
                  <button
                    onClick={() => navigate('/musician/tutorial')}
                    className="w-full flex items-center gap-4 p-4 rounded-lg hover:bg-gray-50 transition-colors text-left"
                  >
