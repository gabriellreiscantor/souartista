...
const DemoMusicianTransportation = () => {
  ...
  const demoHistory = [
    {
      ...
      cost: 35.20,
      description: 'Corrida para show no Teatro Municipal'
    },
    {
      id: '2',
      type: 'Carro/Km Rodado',
      date: `${currentDate.getFullYear()}-${String(currentDate.getMonth() + 1).padStart(2, '0')}-10`,
      cost: 62.50,
      description: 'Show em Pub Rock City - 120km'
    },
    {
      id: '3',
      type: 'Uber',
      date: `${currentDate.getFullYear()}-${String(currentDate.getMonth() + 1).padStart(2, '0')}-15`,
      cost: 28.40,
      description: 'Ida para ensaio'
    },
    {
      id: '4',
      type: 'Ônibus',
      date: `${currentDate.getFullYear()}-${String(currentDate.getMonth() + 1).padStart(2, '0')}-20`,
      cost: 18.50,
      description: 'Passagem para show em cidade vizinha'
    },
    {
      id: '5',
      type: 'Uber',
      date: `${currentDate.getFullYear()}-${String(currentDate.getMonth() + 1).padStart(2, '0')}-25`,
      cost: 22.90,
      description: 'Retorno após apresentação'
    }
  ];
                      ...
                      <div>
                        ...
                        <Select>
                          ...
                          <SelectContent className="bg-white">
                            <SelectItem value="show1">Pub Rock City - 10/11</SelectItem>
                            <SelectItem value="show2">Teatro Municipal - 15/11</SelectItem>
                          </SelectContent>
                        </Select>
                      </div>
...
export default DemoMusicianTransportation;
