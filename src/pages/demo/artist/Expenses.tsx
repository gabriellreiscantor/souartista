...
const demoExpenses = [
  { id: '1', category: 'acessorio' as ExpenseCategory, description: 'Jogo de cordas Elixir', cost: 89.90, expense_date: '2026-01-10' },
  { id: '2', category: 'manutencao' as ExpenseCategory, description: 'Conserto violão', cost: 150.00, expense_date: '2026-01-08' },
  { id: '3', category: 'acessorio' as ExpenseCategory, description: 'Cabo XLR 5m', cost: 45.00, expense_date: '2026-01-05' },
  { id: '4', category: 'marketing' as ExpenseCategory, description: 'Fotos profissionais', cost: 200.00, expense_date: '2026-01-03' },
];

export default function DemoArtistExpenses() {
